...
import { FaBars, FaGlassCheers, FaTimes, FaUser } from 'react-icons/fa';
...
export default function Navbar() {
  ...
  const navbarClass =
    'bg-white/10 dark:bg-gray-900/20 backdrop-blur-md fixed w-full z-50 transition-colors duration-300';
