    ...
    <div className="flex flex-col items-center justify-center min-h-full px-4 py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-700 dark:text-white/90 max-w-2xl">
          The social drinking game that combines fun challenges with questions. Swipe, drink, and
          laugh with friends!
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
        <Link
          href="/game/create"
          className="flex flex-col items-center p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
        >
